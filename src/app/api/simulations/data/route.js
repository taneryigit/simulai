// src/app/api/simulations/data/route.js
...
export async function GET(req) {
  try {
    ...
    // ✅ Fetch simulation data from centralized simulations table
    ...
    const userQuery = `SELECT companyid FROM [users] WHERE id = @userId`;
