// app/api/simulations/positive-images/route.js
...
export async function GET(req) {
  try {
    ...
    // ✅ Construct path: public/{images_folder}/positive
    const folderPath = path.join(process.cwd(), "public", imagesFolderPath, "positive");

    console.log(`Looking for positive images in: ${folderPath}`);
    ...
    console.log(`Found ${imageFiles.length} positive images for simulation: ${simulationName}`);
    ...
    console.error("Error retrieving positive images:", error);
    return new Response(JSON.stringify({ 
